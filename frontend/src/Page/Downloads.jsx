  ...
  return (
    <div>
      <section className="flex justify-center items-center py-20 max-md:py-16 rounded-b-2xl mb-5 relative max-md:h-20 h-48">
        <div className="absolute inset-0 flex justify-center items-center rounded-b-2xl">
          <div className="text-white text-6xl max-md:text-4xl font-extrabold tracking-wider">
            Musichub !
          </div>
        </div>
      </section>
