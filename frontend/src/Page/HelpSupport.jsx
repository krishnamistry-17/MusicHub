    ...
    <div className="max-w-2xl w-full mx-auto mt-14 rounded-2xl">
      ...
      >
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          <Typography>What is MusicHub?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
              MusicHub is a free music streaming website that allows you to
      ...
      >
        <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
          <Typography>How do I use MusicHub?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            To use MusicHub, simply visit the website and sign up to create
      ...
      >
        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
          <Typography>Can I download songs from MusicHub?</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Yes, you can download songs, albums, and playlists from Musichub
        ...
        <AccordionDetails>
          <Typography>
            ...
            <a
              ...
              href="https://twitter.com/musicHubSupport"
            >
              @musicHubSupport
            </a>
            {"     "}
            ...
            <a
              className="text-blue-700 text-xl hover:text-skyBlue"
              href="https://instagram.com/musicHubSupport"
            >
              @musicHubSupport
            </a>
          </Typography>
